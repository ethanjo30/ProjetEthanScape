...
const Navbar = () => {
  return (
    <nav className="p-4 bg-slate-900 border-b border-slate-800 flex justify-between items-center text-white">
      <Link to="/" className="text-xl font-bold text-amber-400">ETHAN SCAPE</Link>
      <div className="flex gap-6">
        <Link to="/" className="hover:text-amber-400 transition-colors">Accueil</Link>
        <Link to="/reservation" className="hover:text-amber-400 transition-colors">Réserver</Link>
      </div>
    </nav>
  );
};
