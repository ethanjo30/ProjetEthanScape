        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <img 
              src={LOGO_URL} 
              alt="EthanScape" 
              className="h-12 w-auto bg-white p-1 rounded-md object-contain mb-4"
            />
...
<div>
  ...
  <ul className="space-y-3">
    {/* Téléphone */}
    <li className="grid grid-cols-[20px_1fr] gap-3 text-slate-400 text-sm items-center">
    ...
    {/* Mail protégé par la grille */}
    <li className="grid grid-cols-[20px_1fr] gap-3 text-slate-400 text-sm items-start">
      <Mail size={20} className="text-amber-400 mt-0.5" />
      <a 
        href="mailto:ethanscape.servicesclients@gmail.com"
        data-testid="footer-email"
        className="hover:text-amber-400 transition-colors break-words"
      >
    ...
    {/* Localisation */}
    <li className="grid grid-cols-[20px_1fr] gap-3 text-slate-400 text-sm items-start">
      <MapPin size={20} className="text-amber-400 mt-0.5" />
